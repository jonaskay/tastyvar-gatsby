...
const ArticleCard = ({ to, title, date }) => (
  <Link
    to={to}
    className="card article-card block hover:border-orange-300 hover:bg-orange-100 hover:shadow-md transition ease-in-out duration-200"
  >
    <div className="article-card-content p-4 border-b border-indigo-300 shadow-sm transition ease-in-out duration-200">
